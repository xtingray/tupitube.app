...
TupFileFlatMenu::TupFileFlatMenu(QSettings *config, QWidget *parent) : QDialog(parent)
{
    setModal(false);
...
TupFileFlatMenu::~TupFileFlatMenu()
{
}

void TupFileFlatMenu::keyReleaseEvent(QKeyEvent *event)
{
